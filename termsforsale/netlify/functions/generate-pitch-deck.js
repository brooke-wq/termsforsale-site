...
function buildTokenMap(page, pageId) {
  ...
  // Photos (Phase 2)
  t.PHOTO_FRONT = EMDASH; t.PHOTO_KITCHEN = EMDASH; t.PHOTO_LIVING = EMDASH; t.PHOTO_PRIMARY_BED = EMDASH; t.PHOTO_BACKYARD = EMDASH; if (photosFolderUrl) t.PHOTOS_FOLDER_URL = photosFolderUrl;
  // Location
