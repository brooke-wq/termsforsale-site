  ...
  try {
    ...
    var deals = pages.map(function(page) {
      ...
      return {
        ...
        // Stack / Morby Method fields — senior DSCR loan + second-position seller carry
        dscrLoanAmount: +prop(page, 'DSCR Loan Amount') || +prop(page, 'DSCR Loan amount') || '',
        dscrLtv: +prop(page, 'DSCR LTV') || '',
        dscrRatio: +prop(page, 'DSCR Ratio') || '',
        annualNoi: +prop(page, 'Annual NOI') || '',
        capRate: +prop(page, 'Cap Rate') || +prop(page, 'Cap rate') || '',
        cashToSeller: +prop(page, 'Cash to Seller') || +prop(page, 'cash to seller') || '',
        netToBuyer: +prop(page, 'Net to Buyer at Closing') || +prop(page, 'net to buyer at closing') || '',
        netCashflow: +prop(page, 'Net Cashflow') || +prop(page, 'net cashflow') || +prop(page, 'Net Cash Flow') || '',
        rentFinal: +rent || '',
        rentLow: '',
        rentMid: '',
        rentHigh: '',
